...
namespace Iridium.Core
{
    ...
    public static class CustomEasingEngine
    {
        ...
        /// <summary>待移除的索引</summary>
        private static readonly System.Collections.Generic.List<int> _pendingRemove = new(32);
        ...
        {
            if (!_initialized || _activeTweens.Count == 0 && _pendingAdd.Count == 0) return;
