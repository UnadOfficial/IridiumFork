        ...
        public static class MoveFloorPatch
        {
            ...
            public static bool Prefix(ffxMoveFloorPlus __instance, scrPlanet planet)
            {
                ...
                void TweenFloor(scrFloor target)
                {
                    ...
                    {
                        if (moveTweens.TryGetValue(TweenType.PositionX, out var old)) old.Kill(true);
                    ...
                    {
                        if (moveTweens.TryGetValue(TweenType.PositionY, out var old)) old.Kill(true);
                    ...
                    {
                        if (moveTweens.TryGetValue(TweenType.Rotation, out var old)) old.Kill(true);
                    ...
                    {
                        if (moveTweens.TryGetValue(TweenType.Opacity, out var old)) old.Kill(true);
                ...
                foreach (scrDecoration dec in __instance.decManager.GetTaggedDecorations(__instance.targetTags))
                {
                    ...
                    if (!__instance.forceDontTweenMovement)
                    {
                        ...
                        if (__instance.positionUsed)
                        {
                            ...
                            {
                                if (tweens.TryGetValue(TweenType.PositionX, out var old)) old.Kill(true);
                            ...
                            {
                                if (tweens.TryGetValue(TweenType.PositionY, out var old)) old.Kill(true);
                        ...
                        if (__instance.parallaxOffsetUsed)
                        {
                            ...
                            {
                                if (tweens.TryGetValue(TweenType.ParallaxOffsetX, out var old)) old.Kill(true);
                            ...
                            {
                                if (tweens.TryGetValue(TweenType.ParallaxOffsetY, out var old)) old.Kill(true);
                        ...
                        if (__instance.pivotUsed)
                        {
                            ...
                            {
                                if (tweens.TryGetValue(TweenType.PivotX, out var old)) old.Kill(true);
                            ...
                            {
                                if (tweens.TryGetValue(TweenType.PivotY, out var old)) old.Kill(true);
                        ...
                        if (__instance.rotationUsed)
                        {
                            if (tweens.TryGetValue(TweenType.Rotation, out var old)) old.Kill(true);
                    ...
                    if (__instance.scaleUsed)
                    {
                        ...
                        {
                            if (tweens.TryGetValue(TweenType.ScaleX, out var old)) old.Kill(true);
                        ...
                        {
                            if (tweens.TryGetValue(TweenType.ScaleY, out var old)) old.Kill(true);
                    ...
                    {
                        if (tweens.TryGetValue(TweenType.Color, out var old)) old.Kill(true);
                        Color sc = dec.color;
                    ...
                    if (__instance.opacityUsed)
                    {
                        if (tweens.TryGetValue(TweenType.Opacity, out var old)) old.Kill(true);
                    ...
                    {
                        if (tweens.TryGetValue(TweenType.Parallax, out var old)) old.Kill(true);
