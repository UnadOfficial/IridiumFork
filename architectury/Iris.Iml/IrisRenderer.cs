    ...
    public class IrisRenderer
    {
        ...
        private void RenderButton(ImlElement element)
        {
            ...
            if (clicked)
            {
                ...
                var onClick = element.GetString("on-click");
        ...
        {
            var classAttr = element.GetString("class");
            var styleAttr = element.GetString("style");
            var key = (!string.IsNullOrEmpty(styleAttr) ? styleAttr : classAttr)?.ToLowerInvariant();
            return key switch
            {
